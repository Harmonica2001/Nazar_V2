            ...
            for box in result.boxes:
                ...
                if confidence > conf_threshold:
                    ...
                    if class_name == "knife":
                        ...
                        ratio = width / height
                        ratio_2 = height/ width
                        print(f"Knife detected — bbox ratio: {ratio:.2f}")

                        # Only accept knife if shape looks valid
                        if ratio >= 0.5 or ratio_2 >= 0.5:
                            print("Knife rejected — shape too wide")
